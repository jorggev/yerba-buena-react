# YERBA BUENA
Este es un proyecto de ecommerce básico. La aplicación permite ver una lista de productos ligados una gran costumbre argentina con el fin de realizar compras en línea. Los productos y las órdenes de compra se almacenan en Firebase.
